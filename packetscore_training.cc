...
void flowProfile(map<unsigned int, map<float, float> > &flowMap){
...
void protocolProfile(map<unsigned int, map<int, float> > &protocolMap){
...
void dstIPProfile(map<unsigned int, map<unsigned int, float> > &dstIPMap){
...
void dstPortProfile(map<unsigned int, map<int, float> > &dstPortMap){
